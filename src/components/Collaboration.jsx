    ...
    <Section crosses>
      <div className="container lg:flex">
            ...
            {collabContent.map((item) => (
              <li className="mb-3 py-3" key={item.id}>
                <div className="flex items-center">
                  <img src={check} width={24} height={24} al="check" />
        ...
        <div className="mt-4 lg:ml-auto xl:w-[38rem]">
          ...
          <div className="-traslate-x-1/2 scale:75 relative left-1/2 mt-4 flex aspect-square w-[22rem] rounded-full border border-n-6 md:scale-100">
